...
1.  What type of study do you think these data come from: observational or experiment?
    Why?
**This data was done observationally because there was no assigned treatments for individuals**

2.  How many observations are in this dataset?
    What does each observation represent?
    
**There are `r nrow(Whickham)` observations in this dataset. Each observation represents one woman in the study.**
...
**There are `r ncol(Whickham)` variables in the dataset. Both `outcome` and `smoker` are are categorical data that are two level fectors. And `age` is a numerical variable.**
...
**I would assume smoker's health is negatively impacted by their smoking status. (i.e smoker would be less healthy than non-smoker)**
...
```
**This did not meet the assumption I made earlier. Smokers, according to this data, have a higher probability of being alive 20 years later.**
...
```
**The plot shows that smokers have a higher probability of being dead in age category**
```{r}
Whickham %>%
